      ...
      <Wrapper className="bg-white rounded-xl py-5">
        ...
        <form>
          ...
          <input
            type="text"
            name="brand_name"
            className="border border-[#6C757D] my-2 mb-7 py-2 px-3 rounded-lg w-full outline-none text-base"
          ...
          <input
            type="text"
            className="border border-[#6C757D] my-2 py-2 mb-7 px-3 rounded-lg w-full outline-none text-base"
          ...
          <button
            type="submit"
            className="bg-[#000000] my-5 rounded-xl text-white px-5 py-2 duration-300 hover:scale-95 min-w-fit w-[100px] font-normal"
          >
            Create
          </button>
        </form>
